...
class TaskController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $openTasks = $taskRepo->findBy(array('status'=>'Open'));
       $inProgressTasks = $taskRepo->findBy(array('status'=>'In Progress'));
       $finishedTasks = $taskRepo->findBy(array('status'=>'Finished'));
